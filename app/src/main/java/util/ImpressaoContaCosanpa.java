...
//				if(ControladorImovel.getInstancia().getImovelSelecionado().getCpfCnpjCliente().equals("                  ")) {
				...
				repNumericaCodBarra += formarLinha(5, 1, 40, 2849, representacaoNumericaCodBarraFormatada, 0, 0);
...
//					repNumericaCodBarra += formarLinha(5, 1, 40, 2864, representacaoNumericaCodBarraFormatada, 0, 0);
...
//					repCodigoBarrasSemDigitoVerificador += "B I2OF5 1 2 90 35 3036 " + representacaoCodigoBarrasSemDigitoVerificador + "\n"; }
//			}
			}	else {
