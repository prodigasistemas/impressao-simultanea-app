...
public class Util {
	...
	/**
	 * Verifica se o valor da String.trim() veio como null ou como
	 * Constantes.NULO_INT, setando como Constantes.NULO_INT caso verdadadeiro
	 * 
	 * @param valor
	 * @return
	 */
	...
	public static String adicionarZerosEsquerdaNumero(int tamanhoMaximoCampo, String numero) {
		...
		boolean ehNegativo = numero != null && !numero.equals(Constantes.NULO_STRING) && !numero.equals(Constantes.NULO_DOUBLE + "") && !numero.equals(Constantes.NULO_INT + "")
				&& !numero.equals(Constantes.NULO_SHORT + "") && numero.charAt(0) == '-';
	...
	/**
	 * Adiciona caracteres a direita da string informada tamamho máximo campo 1
	 * = 15 Palavra "apagar" retorna "apagar         "
	 * 
	 * @param tamanhoMaximoCampo
	 *            Descrição do parâmetro
	 * @param numero
	...
	public static String formatarCodigoBarras(String codigoBarras) {
		...
		if (codigoBarras != null && codigoBarras.length() >= 48) {
			retorno = codigoBarras.substring(0, 11).trim() + "-" + codigoBarras.substring(11, 12).trim() + " " + codigoBarras.substring(12, 23).trim() + "-"
					+ codigoBarras.substring(23, 24).trim() + " " + codigoBarras.substring(24, 35).trim() + "-" + codigoBarras.substring(35, 36).trim() + " "
	...
	public static void inserirValoresStringRelatorio(String quadra, boolean inseridoAnormalidade, boolean inseridoLeitura) {
		...
		// String valoresRelatorio =
		// DadosRelatorio.getInstancia().valoresRelatorio;
		...
		//
		// }
		// String quadraAlteracao = valoresRelatorio.substring(indice, indice +
		// 18);
		// //String lidosLeitura =
		// valoresRelatorio.substring(valoresRelatorio.indexOf("[" +
		// String.valueOf(valoresRelatorio.charAt(1)) + "]"));
		// String lidosLeitura = valoresRelatorio.substring(1,5);
		// //String lidosAnormalidade =
		// valoresRelatorio.substring(valoresRelatorio.indexOf("[" +
		// String.valueOf(valoresRelatorio.charAt(5)) + "]"));
		...
		// }
		//
		// quadraInt = Integer.parseInt(valoresRelatorio.substring(indice + 1
		// ,indice + 5));
		// total = Integer.parseInt(valoresRelatorio.substring(indice + 6,indice
		// + 10));
		// visitados = Integer.parseInt(valoresRelatorio.substring(indice + 10,
		// indice + 14)) + 1;
		// naoVisitados = Integer.parseInt(valoresRelatorio.substring(indice +
		// 14, indice + 18)) - 1;
		//
		// if(naoVisitados < 0 ){
		// naoVisitados = 0;
		...
		// }
		//
		// quadraAlterada = "(" + Util.adicionarZerosEsquerdaNumero(4,
		// String.valueOf(quadraInt)) + ")" +
		...
		//
		// valoresRelatorio = replace(valoresRelatorio, quadraAlteracao,
		// quadraAlterada);
		//
		// DadosRelatorio.getInstancia().valoresRelatorio = valoresRelatorio;
	}

	public static void inserirValoresStringRelatorioCarregamento(String quadra, String quadraAlteracao, boolean inseridoAnormalidade, boolean inseridoLeitura) {
		...
		quadraAlterada = "(" + Util.adicionarZerosEsquerdaNumero(4, String.valueOf(quadraInt)) + ")" + Util.adicionarZerosEsquerdaNumero(4, String.valueOf(total))
				+ Util.adicionarZerosEsquerdaNumero(4, String.valueOf(visitados)) + Util.adicionarZerosEsquerdaNumero(4, String.valueOf(naoVisitados));
	...
	public static void inserirValoresStringRelatorioConsumoNulo(String quadra, boolean inseridoAnormalidade, boolean inseridoLeitura) {
		...
		if (inseridoAnormalidade) {
			...
			int lidos = Integer.parseInt(lidosAnormalidade) - 1;
			valoresRelatorio = replace(valoresRelatorio, "[" + Util.adicionarZerosEsquerdaNumero(4, lidosAnormalidade) + "]",
					"[" + Util.adicionarZerosEsquerdaNumero(4, String.valueOf(lidos)) + "]");
		}
	...
	public static String obterIdentificacaoPagamento(Integer tipoPagamento, Integer idLocalidade, Integer matriculaImovel, String mesAnoReferenciaConta,
			Integer digitoVerificadorRefContaModulo10, Integer idTipoDebito, String anoEmissaoGuiaPagamento, String sequencialDocumentoCobranca, Integer idTipoDocumento,
			Integer idCliente, Integer seqFaturaClienteResponsavel) {
