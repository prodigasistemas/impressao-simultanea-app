...
public class DadosGerais {
	...
	private String descricaoAliquotaAgReguladora;
	
	private BigDecimal valorAliquotaAgReguladora;
	...
	public String getDescricaoAliquotaAgReguladora() {
		return descricaoAliquotaAgReguladora;
	}

	public void setDescricaoAliquotaAgReguladora(String descricaoAliquotaAgReguladora) {
		this.descricaoAliquotaAgReguladora = descricaoAliquotaAgReguladora;
	}

	public BigDecimal getValorAliquotaAgReguladora() {
		return valorAliquotaAgReguladora;
	}

	public void setValorAliquotaAgReguladora(BigDecimal valorAliquotaAgReguladora) {
		this.valorAliquotaAgReguladora = valorAliquotaAgReguladora;
	}
